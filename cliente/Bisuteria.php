...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <a class="text-white px-2" style="margin-top: 1%;" href="index.html">
    ...
    <section>
        ...
        $query_productos = mysqli_query($mysqli, "SELECT * FROM producto WHERE id_categoria=4");
